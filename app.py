...
# Function to recommend a destination based on user preferences
def get_recommendation(user_preferences):
    ...
    distance, index = model.kneighbors(encoded_preferences)
    recommended_destination = destinations[index[0][0]]['name']
